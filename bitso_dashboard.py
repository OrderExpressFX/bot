...
st.sidebar.caption(f"Entered: **${mxn_exposure_limit:,.2f} MXN**")", min_value=0.0, value=8000000.0, format="%.2f", help="e.g. 8,000,000.00")
...
st.sidebar.caption(f"Entered: **${usd_exposure_limit:,.2f} USD**")", min_value=0.0, value=450000.0, format="%.2f", help="e.g. 450,000.00")
...
st.sidebar.caption(f"Entered: **${target_sell_mxn:,.2f} MXN**")", min_value=0.0, value=8000000.0, format="%.2f", help="e.g. 8,000,000.00")
target_sell_usd = st.sidebar.number_input("Target Sell USD (USD)", min_value=0.0, value=450000.0, format="%.2f", help="e.g. 450,000.00")
st.sidebar.caption(f"Entered: **${target_sell_usd:,.2f} USD**")", min_value=0.0, value=450000.0, format="%.2f", help="e.g. 450,000.00")
...
st.sidebar.caption(f"Entered: **${block_size:,.2f} MXN**")", min_value=10000.0, value=500000.0, step=10000.0, format="%.2f", help="e.g. 500,000.00")
