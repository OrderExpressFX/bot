...
st.sidebar.caption(f"Entered: **${mxn_exposure_limit:,.2f} MXN**"))
...
st.sidebar.caption(f"Entered: **${usd_exposure_limit:,.2f} USD**"))
...
st.sidebar.caption(f"Entered: **${target_sell_mxn:,.2f} MXN**"))
